...
docker tag  reward-calculator-naming-server:1.0 sureshdharisi123/reward-calculator-naming-server:1.0.0
docker push sureshdharisi123/reward-calculator-naming-server:1.0.0
cd ..
...
docker tag  reward-points-store:1.0 sureshdharisi123/reward-points-store:1.0.0
docker push sureshdharisi123/reward-points-store:1.0.0
cd ..
...
docker tag  customer-transactions:1.0 sureshdharisi123/customer-transactions:1.0.0
docker push sureshdharisi123/customer-transactions:1.0.0
cd ..
...
docker tag  rewards-calculator:1.0 sureshdharisi123/rewards-calculator:1.0.0
docker push sureshdharisi123/rewards-calculator:1.0.0
cd ..
